...
import pl.piznal.health.repository.PreferencesRepository;
...
import pl.piznal.health.domain.enumeration.Units;
/**
...
public class PreferencesResourceIntTest {
    ...
    public void setup() {
        ...
        PreferencesResource preferencesResource = new PreferencesResource(preferencesRepository);
